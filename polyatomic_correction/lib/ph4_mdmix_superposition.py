#! /usr/bin/env python
"""
    Compare MDMix Grids with pharmacophore points saved as ph4 files.


	USAGE: ph4_mdmix_superposition.py inputph4.ph4 ph4ranking.txt path/to/grids.dx outputprefix [onlycenter]
